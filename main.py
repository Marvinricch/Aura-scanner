...
ENTRY_BOS_MAX_BARS_AGO = int(os.getenv("ENTRY_BOS_MAX_BARS_AGO", "3"))  # BOS older than this many candles is stale — reject rather than trade off structure that's no longer fresh
