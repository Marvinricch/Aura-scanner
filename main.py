...
async def build_snapshot(symbol: str, ticker_24h: dict | None) -> SymbolSnapshot | None:
    ...
    if snap.signal in ("BUY", "SELL"):
        ...
        quality = evaluate_signal_quality(
            ...
            daily_ctx["oi_30d_ago"], daily_ctx["oi_latest_from_history"],
...
DAILY_CONTEXT_CACHE: dict[str, dict] = {}  # symbol -> {"fetched_at", "oi_30d_ago", "oi_latest_from_history", "avg_volume_7d", "daily_resistance", "daily_support", "funding_rate_history"} — refreshed rarely, these change slowly
